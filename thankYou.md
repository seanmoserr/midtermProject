...
This project was compiled using markdown (.md) files on GitHub. This assignment helped me to practice using markdown in order to easily create webpages that can be represented in an HTML format.
